      ...
      <div id="detailButtons" class="detailInner Block">
        <?php
          ...
          if($record != 0){
            ...
            echo "<button id='job_pk' class='detailButton' value='" . $result['job_pk'] . "' onclick='update(this)'>Save Changes</button>";
          } else {
            echo "<button id='job_pk' class='detailButton' value='0' onclick='update(this)'>Create Record</button>";
          }
          ?>
