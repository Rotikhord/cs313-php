  ...
  <div class="detailBlock" id="punchHeader">
    <div class="detailInnerBlock">
      <h4>PunchList Item Details:</h4>
        <?php
          $blockFields = array('pun_summary', 'pun_date', 'pun_last_update', 'pun_complete_date');
          $blockLabels = array('Item Summary', 'Escalation Date', 'Last Updated', 'Date Completed');
      ...
      <div class="detailInnerBlock">
          <?php
            echo "<label for='job_description'>Description</label><br>";
            echo "<textarea class='lockedInput' id='pun_description'  readonly>" . $result['pun_description'] . "</textarea><br>";
          ?>
        </div>
  </div>
